...
return new class extends Migration
{
    ...
    {
        Schema::create('vehiclefasttaglogs', function (Blueprint $table) {
            $table->bigInteger('id', true);
            $table->bigInteger('vehiclefasttag_id')->comment('FK → vehiclefasttags.id');
    ...
    {
        Schema::dropIfExists('vehiclefasttaglogs');
    }
};
