...
return new class extends Migration
{
    ...
    {
        Schema::create('vehicledigitallocklogs', function (Blueprint $table) {
            $table->bigInteger('id', true);
            $table->bigInteger('vehicledigitallock_id')->comment('FK → vehicledigitallocks.id');
    ...
    {
        Schema::dropIfExists('vehicledigitallocklogs');
    }
};
