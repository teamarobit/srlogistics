...
class FasttagProviderController extends Controller
{
    use Useractivity;
    ...
    {
        return view('provider.fasttag.create');
    }
    ...
    public function edit($id)
    {
        ...
        $record = Fasttagprovider::find($id);
        ...
        return view('provider.fasttag.edit', compact('record'));
    }
    ...
    public function update(Request $request)
    {
        ...
        $record = Fasttagprovider::find($request->get('recordid'));
