...
@section('content')
    <div class="layout-wrapper">
        ...
        <div class="vehicledtl-bd srlog-bdwrapper">
            ...
            <form class="vehicle-itemtab pt-4" id="addTyreForm" action="{{ route('fleetdashboard.updateTyreDetails', $vehicle->id) }}">
                @csrf
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 col-md-4">
                            <div class="card left-wrap">
                                ...
                                <select class="form-select mt-4" id="type" name="wheel_count">
                                    @if($vehicletyers->count() == 6)
                                        <option value="6">6 + 1  Wheeler</option>
                                    @elseif($vehicletyers->count() == 10)
                        ...
                        <div class="col-12 col-md-8">
                            ...
                            @forelse($tyrepositions as $tyreposition)
                                @php
                                    $record = $vehicletyers->get($tyreposition->id);
                                @endphp
                                @if(!in_array($tyreposition->code, ['S1']) && $record)
                                        ...
                                        <div>
                                            <div class="row">
                                                <div class="form-group col-12 col-md-3">
                                                    ...
                                                    <input type="text" name="tyre_brand[{{ $tyreposition->id }}]" class="form-control" value="{{ $record->tyre_brand }}">
                                                ...
                                                <div class="form-group col-12 col-md-3">
                                                    ...
                                                    <input type="text" name="tyre_model_name[{{ $tyreposition->id }}]" class="form-control" value="{{ $record->tyre_model }}">
                                                ...
                                                <div class="form-group col-12 col-md-3">
                                                    ...
                                                    <select name="tyre_type[{{ $tyreposition->id }}]" class="form-control">
                                                        ...
                                                        <option name="Radial" @if($record->tyre_brand == 'Radial') selected @endif>Radial</option>
                                                        <option name="Nylon" @if($record->tyre_brand == 'Nylon') selected @endif>Nylon</option>
                                                    </select>
                                                ...
                                                <div class="form-group col-12 col-md-3">
                                                    ...
                                                    <input type="text" name="tyre_price[{{ $tyreposition->id }}]" class="form-control" value="{{ $record->tyre_price }}">
                                                ...
                                                <div class="form-group col-12 col-md-3">
                                                    ...
                                                    <input type="text" name="tyre_serial_number[{{ $tyreposition->id }}]" class="form-control" value="{{ $record->tyre_serial_number }}">
                                                ...
                                                <div class="form-group col-12 col-md-3">
                                                    ...
                                                    <input type="date" name="tyre_purchase_date[{{ $tyreposition->id }}]" class="form-control general_date" value="{{ date('Y-m-d', strtotime($record->tyre_purchase_date)) }}">
                                                ...
                                                <div class="form-group col-12 col-md-3">
                                                    ...
                                                    <input type="date" name="tyre_issue_date[{{ $tyreposition->id }}]" class="form-control general_date" value="{{ date('Y-m-d', strtotime($record->tyre_issue_date)) }}">
                                                ...
                                                <div class="form-group col-12 col-md-3">
                                                    ...
                                                    <input type="text" name="tyre_warranty_months[{{ $tyreposition->id }}]" class="form-control" value="{{ $record->tyre_warranty_months }}">
                                                    <small class="error text-danger" id="add_tyre_warranty_months_{{ $tyreposition->id }}_error"></small>
                                                </div>
                                                <div class="form-group col-12 col-md-3">
                                                    <label>Tyre Fixed Run KM</label>
                                                    <input type="text" name="fixed_run_km[{{ $tyreposition->id }}]" class="form-control" value="{{ $record->fixed_run_km }}">
                                                    <small class="error text-danger" id="add_fixed_run_km_{{ $tyreposition->id }}_error"></small>
                                                </div>
                                                <div class="form-group col-12 col-md-3">
                                                    <label>Tyre Fixed Life (Months)</label>
                                                    <input type="text" name="fixed_life_months[{{ $tyreposition->id }}]" class="form-control" value="{{ $record->fixed_life_months }}">
                                                    <small class="error text-danger" id="add_fixed_life_months_{{ $tyreposition->id }}_error"></small>
                                                </div>
                                                <div class="form-group col-12 col-md-3">
                                                    <label>Tyre Actual Run KM</label>
                                                    <input type="text" name="actual_run_km[{{ $tyreposition->id }}]" class="form-control" value="{{ $record->actual_run_km }}">
                                                    <small class="error text-danger" id="add_actual_run_km_{{ $tyreposition->id }}_error"></small>
                                                </div>
                                                <div class="form-group col-12 col-md-3">
                                                    <label>Tyre Actual Run Month</label>
                                                    <input type="text" name="actual_run_month[{{ $tyreposition->id }}]" class="form-control" value="{{ $record->actual_run_month }}">
                                                    <small class="error text-danger" id="add_actual_run_month_{{ $tyreposition->id }}_error"></small>
                                                </div>
                                                <div class="form-group col-12 col-md-3">
                                                    <label>Tyre Remaining Run KM</label>
                                                    <input type="text" name="remaining_run_km[{{ $tyreposition->id }}]" class="form-control" value="{{ $record->remaining_run_km }}">
                                                ...
                                                <div class="form-group col-12 col-md-3">
                                                    ...
                                                    <input type="text" name="remaining_life_month[{{ $tyreposition->id }}]" class="form-control" value="{{ $record->remaining_run_month }}">
                                                ...
                                                <div class="form-group col-12 col-md-3">
                                                    ...
                                                    <input type="text" name="last_alignment_km[{{ $tyreposition->id }}]" class="form-control" value="{{ $record->last_alignment_km }}">
                                                    <small class="error text-danger" id="add_last_alignment_km_{{ $tyreposition->id }}_error"></small>
                                                </div>
                                                <div class="form-group col-12 col-md-3">
                                                    <label>Last Wheel Rotation KM</label>
                                                    <input type="text" name="last_rotation_km[{{ $tyreposition->id }}]" class="form-control" value="{{ $record->last_rotation_km }}">
                                                ...
                                                <div class="form-group col-6 col-md-4">
                                                    ...
                                                    <input type="text" name="alignment_interval_km[{{ $tyreposition->id }}]" class="form-control" value="{{ $record->alignment_interval_km }}">
                                                    <small class="error text-danger" id="add_alignment_interval_km_{{ $tyreposition->id }}_error"></small>
                                                </div>
                                                <div class="form-group col-6 col-md-2">
                                                    <label>Set Reminder?</label>
                                                    <input type="checkbox" name="set_reminder_for_alignment[{{ $tyreposition->id }}]" @if($record->set_reminder_for_alignment == 'Yes') checked @endif>
                                                ...
                                                <div class="form-group col-6 col-md-4">
                                                    ...
                                                    <input type="text" name="rotation_interval_km[{{ $tyreposition->id }}]" class="form-control" value="{{ $record->rotation_interval_km }}">
                                                    <small class="error text-danger" id="add_rotation_interval_km_{{ $tyreposition->id }}_error"></small>
                                                </div>
                                                <div class="form-group col-6 col-md-2">
                                                    <label>Set Reminder?</label>
                                                    <input type="checkbox" name="set_reminder_for_rotation[{{ $tyreposition->id }}]" @if($record->set_reminder_for_rotation == 'Yes') checked @endif>
                            ...
                            <div class="card">
                                @php
                                    $record = $vehicletyers->get($stepney_id);
                                @endphp
                                ...
                                <div>
                                    <div class="row">
                                        <div class="form-group col-12 col-md-3">
                                            ...
                                            <input type="text" name="stepney_tyre_brand" class="form-control" value="{{ $record?->tyre_brand }}">
                                            <small class="error text-danger" id="add_stepney_tyre_brand_error"></small>
                                        </div>
                                        <div class="form-group col-12 col-md-3">
                                            <label>Tyre Model</label>
                                            <input type="text" name="stepney_tyre_model_name" class="form-control" value="{{ $record?->tyre_model }}">
                                        ...
                                        <div class="form-group col-12 col-md-3">
                                            ...
                                            <input type="text" name="stepney_tyre_price" class="form-control" value="{{ $record?->tyre_price }}">
                                            <small class="error text-danger" id="add_stepney_tyre_price_error"></small>
                                        </div>
                                        <div class="form-group col-12 col-md-3">
                                            <label>Tyre Serial Number</label>
                                            <input type="text" name="stepney_tyre_serial_number" class="form-control" value="{{ $record?->tyre_serial_number }}">
                                            <small class="error text-danger" id="add_stepney_tyre_serial_number_error"></small>
                                        </div>
                                        
                                        <div class="form-group col-12 col-md-3">
                                            <label>Tyre Purchase Date</label>
                                            <input type="date" name="stepney_tyre_purchase_date" class="form-control general_date" value="{{ date('Y-m-d', strtotime($record?->tyre_purchase_date)) }}">
                                            <small class="error text-danger" id="add_stepney_tyre_purchase_date_error"></small>
                                        </div>
                                        <div class="form-group col-12 col-md-3">
                                            <label>Tyre Issue Date</label>
                                            <input type="date" name="stepney_tyre_issue_date" class="form-control general_date" value="{{ date('Y-m-d', strtotime($record?->tyre_issue_date)) }}">
                                            <small class="error text-danger" id="add_stepney_tyre_issue_date_error"></small>
                                        </div>
                                        <div class="form-group col-12 col-md-3">
                                            <label>Warranty Period (Months)</label>
                                            <input type="text" name="stepney_tyre_warranty_months" class="form-control" value="{{ $record?->tyre_warranty_months }}">
                                            <small class="error text-danger" id="add_stepney_tyre_warranty_error"></small>
                                        </div>
                                        <div class="form-group col-12 col-md-3">
                                            <label>Tyre Fixed Run KM</label>
                                            <input type="text" name="stepney_fixed_run_km" class="form-control" value="{{ $record?->fixed_life_km }}">
                                            <small class="error text-danger" id="add_stepney_fixed_run_km_error"></small>
                                        </div>
                                        <div class="form-group col-12 col-md-3">
                                            <label>Tyre Fixed Life (Months)</label>
                                            <input type="text" name="stepney_fixed_life_months" class="form-control" value="{{ $record?->fixed_life_months }}">
                                            <small class="error text-danger" id="add_stepney_fixed_life_months_error"></small>
                                        </div>
                                        <div class="form-group col-12 col-md-3">
                                            <label>Tyre Actual Run KM</label>
                                            <input type="text" name="stepney_actual_run_km" class="form-control" value="{{ $record?->actual_run_km }}">
                                            <small class="error text-danger" id="add_stepney_actual_run_km_error"></small>
                                        </div>
                                        <div class="form-group col-12 col-md-3">
                                            <label>Tyre Actual Run Month</label>
                                            <input type="text" name="stepney_actual_run_month" class="form-control" value="{{ $record?->actual_run_month }}">
                                            <small class="error text-danger" id="add_stepney_actual_run_month_error"></small>
                                        </div>
                                        <div class="form-group col-12 col-md-3">
                                            <label>Tyre Remaining Run KM</label>
                                            <input type="text" name="remaining_run_km" class="form-control" value="{{ $record?->remaining_run_km }}">
                                            <small class="error text-danger" id="add_remaining_run_km_error"></small>
                                        </div>
                                        <div class="form-group col-12 col-md-3">
                                            <label>Tyre Remaining Life (Months)</label>
                                            <input type="text" name="stepney_remaining_life_month" class="form-control" value="{{ $record?->remaining_life_month }}">
                                            <small class="error text-danger" id="add_stepney_remaining_life_month_error"></small>
                                        </div>
                                        <div class="form-group col-12 col-md-3">
                                            <label>Last Wheel Alignment KM</label>
                                            <input type="text" name="stepney_last_alignment_km" class="form-control" value="{{ $record?->last_alignment_km }}">
                                            <small class="error text-danger" id="add_stepney_last_alignment_km_error"></small>
                                        </div>
                                        <div class="form-group col-12 col-md-3">
                                            <label>Last Wheel Rotation KM</label>
                                            <input type="text" name="last_rotation_km" class="form-control" value="{{ $record?->last_rotation_km }}">
                                            <small class="error text-danger" id="add_last_rotation_km_error"></small>
                                        </div>
                                        <div class="form-group col-6 col-md-4">
                                            <label>Wheel Alignment Interval KM</label>
                                            <input type="text" name="stepney_alignment_interval_km" class="form-control" value="{{ $record?->alignment_interval_km }}">
                                            <small class="error text-danger" id="add_stepney_alignment_interval_km_error"></small>
                                        </div>
                                        <div class="form-group col-6 col-md-2">
                                            <label>Set Reminder?</label>
                                            <input type="checkbox" name="stepney_set_reminder_for_alignment" @if($record?->set_reminder_for_alignment == 'Yes') checked @endif>
                                            <small class="error text-danger" id="add_stepney_set_reminder_for_alignment_error"></small>
                                        </div>
                                        <div class="form-group col-6 col-md-4">
                                            <label>Tyre Rotation Interval KM</label>
                                            <input type="text" name="stepney_rotation_interval_km" class="form-control" value="{{ $record?->rotation_interval_km }}">
                                            <small class="error text-danger" id="add_stepney_rotation_interval_km_error"></small>
                                        </div>
                                        <div class="form-group col-6 col-md-2">
                                            <label>Set Reminder?</label>
                                            <input type="checkbox" name="stepney_set_reminder_for_rotation" @if($record?->set_reminder_for_rotation == 'Yes') checked @endif>
...
<script type="text/javascript" src="{{ asset('public/customjs/fleet/tyre/edit.js') }}?v={{ uniqid() }}"></script>
