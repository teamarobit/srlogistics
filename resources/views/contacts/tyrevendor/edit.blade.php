...
<link rel="stylesheet" href="{{ asset('css/Contacts/TyreVendor/edit.css?v=1.1') }}">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-7 d-flex flex-wrap status-wrap">
                                            ...
                                            <div class="form-check me-2 active">
                                                <input class="form-check-input vehiclevendor-status" type="radio" name="status" id="active" value="Active" {{ $contact->status == 'Active' ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check mx-1 inactive">
                                                <input class="form-check-input vehiclevendor-status" type="radio" name="status" id="inactive" value="Inactive" {{ $contact->status == 'Inactive' ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check mx-0">
                                                <input class="form-check-input status-trigger vehiclevendor-status" type="radio" name="status" id="blacklist" value="Blacklisted" {{ $contact->status == 'Blacklisted' ? 'checked' : '' }}>
                                            ...
                                            <div class="bank-data border p-3 mb-3 position-relative">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-7 d-flex">
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input vehiclevendor-status" type="radio" name="is_primary[{{ $index }}]" id="is_primary_yes" value="Yes" {{ $contactBank->is_primary == 'Yes' ? 'checked' : '' }} />
                                                        ...
                                                        <div class="form-check mx-2">
                                                            <input class="form-check-input vehiclevendor-status" type="radio" name="is_primary[{{ $index }}]" id="is_primary_no" value="No" {{ $contactBank->is_primary == 'No' ? 'checked' : '' }} />
                    ...
                    <div class="col-12 col-md-8 mt-4">
                        <div class="right-side-wrap">
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                   <button class="nav-link " data-bs-toggle="tab" data-bs-target="#tyre" type="button" role="tab">
                                        Tyre
                                    </button>
                                </li>
