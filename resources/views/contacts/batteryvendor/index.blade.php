                ...
                <div class="container-fluid page-head">
                    <div class="row align-items-center">
                        <div class="col-12 d-flex align-items-center p-0">
                            ...
                            <h6 class="d-inline-block m-1">Battery Vendor</h6>
                            
                            @if (Route::has('contact.batteryvendor.create')) 
                            <a href="{{ route('contact.batteryvendor.create') }}" class="btn btn-theme mb-0" style="padding: 8px 21px !important;"><i class="uil uil-plus me-1"></i>Battery Vendor</a>
                            @endif
                            
                            <form action="{{ route('contact.batteryvendor.index') }}" id="searchform" class="d-flex align-items-center m-1">
                                ...
                                <a href="{{ route('contact.batteryvendor.index') }}" style="text-transform: capitalize;" class="btn btn-primary reset-btn ms-1">Reset</a>
                                    ...
                                    <td class="text-end">
                                        <div class="dropdown dot-dd">
                                          ...
                                          <ul class="dropdown-menu" aria-labelledby="moreTable" style="">
                                            <li><a class="dropdown-item" href="{{ route('contact.batteryvendor.edit', $contact->id) }}"><i class="uil uil-pen me-2"></i>Edit</a></li>
