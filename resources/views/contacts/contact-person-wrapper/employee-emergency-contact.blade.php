<div class="contact-person" data-index="{{ $rowindex }}">
  ...
  <div class="row form-group">
    <div class="col-12 col-md-5">
        <label><span class="cpdglbl">Relation </label>
    </div>
    <div class="col-12 col-md-7">
        <input type="text" class="form-control" name="contact_person_relation[]">
        <div class="error text-danger cpdgerr" id="contact_person_relation_{{ $rowindex }}_error"></div>
    </div>
  </div>
  
  <div class="row form-group">
    <div class="col-12 col-md-5">
        <label><span class="cpdglbl">Blood Group </label>
    </div>
    <div class="col-12 col-md-7">
        ...
        <div class="error text-danger cpdgerr" id="contact_person_blood_group_{{ $rowindex }}_error"></div>
    </div>
  </div>
  
  <div class="row form-group">
    <div class="col-12 col-md-5">
        <label><span class="cpdglbl">Address </label>
    </div>
    <div class="col-12 col-md-7">
        <input type="text" class="form-control" name="contact_person_address[]">
        <div class="error text-danger cpdgerr" id="contact_person_address_{{ $rowindex }}_error"></div>
    </div>
  </div>
