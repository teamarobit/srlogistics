            ...
            <div class="main-wrap">
                <div class="container-fluid page-head">
                    <div class="row align-items-end">
                        <div class="col-12">
                            <h5 class="d-inline-block mb-0">Customer</h5>
                            
                            @if (Route::has('contact.customer.create')) 
                            <a href="{{ route('contact.customer.create') }}" class="btn btn-theme mb-0 ms-2"><i class="uil uil-plus me-1"></i>Customer</a>
                            @endif
                            
                            
                            <form action="{{ route('contact.customer.index') }}" id="searchform" class="d-inline-block">
                                ...
                                <div class="search-wrap d-inline-block ms-2" style="width: 150px;">
                                    <select class="form-select select2" name="size" id="search_size">
                            ...
                            <a href="{{ route('contact.customer.index') }}" class="btn btn-primary reset-btn"><i class="uil uil-history me-1"></i>Reset</a>
                        ...
                        <tbody>
                            @if($contacts->count())
                                ...
                                <tr>
                                    ...
                                    <td>{{ $contact->abouttype?->name ?? '-' }}</td> 
                                    <td>{{ $contact->size ?? '-' }}</td>
                                    <td>{{ $contact->city?->name ?? '-' }}</td>
                                    <td>
                                        
                                        {{ $contact->customerlocations?->count() ?? 0 }}
                                        
                                        {{--@forelse($contact->customerlocations as $location)
                                            <span class="tag">
                                    ...
                                    <td class="text-end">
                                        <div class="dropdown dot-dd">
                                          ...
                                          <ul class="dropdown-menu" aria-labelledby="moreTable" style="">
                                            <li><a class="dropdown-item" href="{{ route('contact.customer.edit', $contact->id) }}"><i class="uil uil-pen me-2"></i>Edit</a></li>
                                            {{--<li><a class="dropdown-item text-danger deleteRecord" data-id="{{ $contact->id }}" data-actmodelid="3" href="javascript:void(0)"><i class="uil uil-trash-alt me-2"></i>Delete</a></li>--}}
                                          </ul>
                                        </div>
                                    </td>
                                </tr>
