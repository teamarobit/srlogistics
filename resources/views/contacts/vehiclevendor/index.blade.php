                ...
                <div class="container-fluid page-head">
                    <div class="row align-items-center">
                        <div class="col-12 d-flex align-items-center p-0">
                            ...
                            <h6 class="d-inline-block m-1">Vehicle Vendor</h6>
                            
                            @if (Route::has('contact.vehiclevendor.create')) 
                            <a href="{{ route('contact.vehiclevendor.create') }}" class="btn btn-theme mb-0" style="padding: 8px 21px !important;"><i class="uil uil-plus me-1"></i>Vehicle Vendor</a>
                            @endif
                    ...
                    <table class="table table-hover invoice-table mb-0">
                        <thead>
                            <tr>
                                ...
                                <th>No. of Vehicles<br/><span class="text-secondary">Size</span></th>
                                <th>No. of Routes<br/><span class="text-secondary">Location</span></th>
                                <th>RAG Status</th>
                                <th>Status</th>
                                <th>Created by</th>
                                <th class="text-end">
                                    ...
                                    <td class="text-end">
                                        <div class="dropdown dot-dd">
                                          ...
                                          <ul class="dropdown-menu" aria-labelledby="moreTable" style="">
                                            <li><a class="dropdown-item" href="{{ route('contact.vehiclevendor.edit', $contact->id) }}"><i class="uil uil-pen me-2"></i>Edit</a></li>
