...
<link rel="stylesheet" href="{{ asset('css/Contacts/VehicleVendor/create.css?v=1.0') }}">
    ...
    <form class="wrapper srlog-bdwrapper" action="{{route('contact.'.str($cotype->slug)->lower().'.save')}}" id="addContactForm">   
        ...
        <div class="itemtop-secwrap">
            <div class="container-fluid">
                <h5 class="d-inline-block">Add Vehicle Vendor</h5>
                                ...
                                <div class="collapse show" id="collapse03">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-7">
                                            ...
                                            <small class="error text-danger" id="add_vehicle_ownership_type_id_error"></small>
                                        </div>
                                    </div>
                    ...
                    <div class="col-12 col-md-8 mt-4">
                        <div class="right-side-wrap">
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                   <button class="nav-link disabled" data-bs-toggle="tab" data-bs-target="#vehicle" type="button" role="tab">
                                        Vehicle
                                    </button>
                                </li>
                                
                                <li class="nav-item" role="presentation">
                                   <button class="nav-link disabled" data-bs-toggle="tab" data-bs-target="#route" type="button" role="tab">
                                        Route
                                    </button>
                                </li>
