            ...
            <div class="main-wrap">
                ...
                <div class="container-fluid mt-3" style="max-width: 860px;">
                    {{--
                        ...
                        SD-3: Form submitted via $.ajax() in create.js.
                    --}}
                    <form id="whCreateForm"
                          action="{{ route('warehouse.master.store') }}"
                          method="POST"
                          novalidate
                          data-cities-url="{{ route('warehouse.cities.by-state', '__STATE_ID__') }}"
                          data-old-state="{{ old('state_id', '') }}"
                          data-old-city="{{ old('city_name', '') }}"
                            ...
                            <div class="row g-3">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" class="form-control"
                                           name="name" id="wh_name" value="{{ old('name') }}"
                                           maxlength="100" placeholder="e.g. Hyderabad Central Warehouse" autofocus>
                                    @error('name')
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="warehouse_type" id="wh_type">
                                        ...
                                        <option value="Central"   {{ old('warehouse_type') === 'Central'   ? 'selected' : '' }}>Central</option>
                                        <option value="Regional"  {{ old('warehouse_type') === 'Regional'  ? 'selected' : '' }}>Regional</option>
                                        <option value="Site/Yard" {{ old('warehouse_type') === 'Site/Yard' ? 'selected' : '' }}>Site / Yard</option>
                                    </select>
                        ...
                        <div class="wh-form-card">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    {{--
                                        Select2 with tags:true — city name as text value.
                                        Existing cities load from AJAX on state change.
                                        If typed value not in list it becomes a new tag (auto-inserted on save).
                                    --}}
                                    <select class="form-select"
                                            name="city_name" id="wh_city_name" style="width:100%;"
                                            {{ old('state_id') ? '' : 'disabled' }}>
                                        @if(old('city_name'))
                                            <option value="{{ old('city_name') }}" selected>{{ old('city_name') }}</option>
                                        @endif
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="location_name" id="wh_location_name"
                                           value="{{ old('location_name') }}" maxlength="150" placeholder="Landmark / area / zone">
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select select2"
                                        ...
                                        @foreach($managers as $mgr)
                                            <option value="{{ $mgr->id }}" {{ old('manager_contact_id') == $mgr->id ? 'selected' : '' }}>
                                                {{ $mgr->contact_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control numberonly"
                                           ...
                                           value="{{ old('contact_number') }}" maxlength="15" placeholder="e.g. 9876543210">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" name="storage_type" id="wh_storage_type">
                                        ...
                                        <option value="Rack"      {{ old('storage_type') === 'Rack'       ? 'selected' : '' }}>Rack</option>
                                        <option value="Floor"     {{ old('storage_type') === 'Floor'      ? 'selected' : '' }}>Floor</option>
                                        <option value="Open Yard" {{ old('storage_type') === 'Open Yard'  ? 'selected' : '' }}>Open Yard</option>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" name="notes" id="wh_notes" rows="2"
                                              maxlength="500" placeholder="Any additional notes…">{{ old('notes') }}</textarea>
                                </div>
                            </div>

                            <div class="wh-form-footer">
                                <button type="submit" class="btn btn-primary" id="btnSave">
                                    <span id="btnSaveText">Save Warehouse</span>
...
<script src="{{ asset('js/Warehouse/create.js?v=1.0') }}"></script>
@endsection
