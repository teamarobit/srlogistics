...
<link rel="stylesheet" href="{{ asset('css/Provider/digilock-index.css') }}">
                ...
                <div class="container-fluid page-head">
                    <div class="row align-items-end">
                        <div class="col-12">
                            ...
                            <a href="{{ route('digilockprovider.create') }}" class="btn btn-theme mb-0 ms-2"><i class="uil uil-plus me-1"></i>Digital Lock Provider</a>
...
<script type="text/javascript" src="{{ asset('customjs/provider/digilock/index.js') }}"></script>
@endsection