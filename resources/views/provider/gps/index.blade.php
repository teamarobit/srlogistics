                ...
                <div class="container-fluid page-head">
                    <div class="row align-items-end">
                        <div class="col-12">
                            ...
                            <h5 class="d-inline-block mb-0">GPS Provider</h5>
                            <a href="{{ route('gpsprovider.create') }}" class="btn btn-theme mb-0 ms-2"><i class="uil uil-plus me-1"></i>GPS Provider</a>
                            
                            <form action="{{ route('gpsprovider.index') }}" id="searchform" class="d-inline-block">
                            ...
                            <a href="{{ route('gpsprovider.index') }}" class="btn btn-primary reset-btn"><i class="uil uil-history me-1"></i>Reset</a>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" src="{{ asset('public/customjs/provider/gps/index.js') }}?v={{ time() }}"></script>
@endsection