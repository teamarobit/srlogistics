            ...
            <div class="main-wrap">
                ...
                <div class="addroute-bd">
                  <div class="container-fluid">
                    ...
                    <form action="{{route('gpsprovider.update')}}" method="POST" id="editForm">
                        @csrf
...
<script type="text/javascript" src="{{asset('public/customjs/provider/gps/edit.js')}}"></script>
