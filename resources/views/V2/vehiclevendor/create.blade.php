        ...
        <div class="cv2-container">
            ...
            <div class="cv2-phead">
                <div>
                    ...
                    <div class="cv2-sub">Create the vendor record. Vehicle, Route, Documents &amp; Activity open once it is saved.</div>
                </div>
                <div class="cv2-phead-actions">
                    <a href="{{ route('contact.v2.vehiclevendor.index') }}" class="cv2-btn cv2-btn-soft">Cancel</a>
                    <button type="submit" form="cv2VendorForm" class="cv2-btn cv2-btn-primary"><i class="bi bi-check2"></i>Save Vendor</button>
                </div>
            </div>

            <form id="cv2VendorForm" action="javascript:void(0)" data-create="1">
            <div class="cv2-grid cv2-grid-2-1">
                <div style="display:flex;flex-direction:column;gap:16px;">
                    ...
                    <div class="cv2-card">
                        ...
                        <div class="cv2-card-b">
                            <div class="cv2-form-grid">
                                <div class="cv2-field"><label class="cv2-label">Company Name <span class="req">*</span></label><input type="text" name="company_name" placeholder="e.g. Brahmaputra Carriers" maxlength="100"></div>
                                ...
                                <div class="cv2-field"><label class="cv2-label">Contact Code <span class="req">*</span></label><input type="text" name="contact_code" placeholder="e.g. VV-BC-01" maxlength="100"></div>
                                <div class="cv2-field"><label class="cv2-label">No. of Vehicles</label><input type="number" name="no_of_vehicles" placeholder="0" min="0"></div>
                                <div class="cv2-field"><label class="cv2-label">Size</label><select class="cv2-select" name="size" style="width:100%;"><option value="">Choose…</option><option>Small</option><option>Medium</option><option>Large</option></select></div>
                                <div class="cv2-field"><label class="cv2-label">RAG Status</label><select class="cv2-select" name="rag_status" style="width:100%;"><option value="">Choose…</option><option>Green</option><option>Yellow</option><option>Red</option></select></div>
                    ...
                    <div class="cv2-card">
                        ...
                        <div class="cv2-card-b">
                            <div class="cv2-form-grid">
                                <div class="cv2-field"><label class="cv2-label">Phone <span class="req">*</span></label><input type="tel" name="phone" data-intl-phone="1" placeholder="98640 22114"></div>
                                <div class="cv2-field"><label class="cv2-label">WhatsApp</label><input type="tel" name="whatsapp" data-intl-phone="1" placeholder="98640 22114"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cv2-card">
                        ...
                        <div class="cv2-card-b">
                            <div class="cv2-form-grid">
                                ...
                                <div class="cv2-field"><label class="cv2-label">Vehicle Ownership Type</label><select class="cv2-select" name="vehicle_ownership_type_id" style="width:100%;"><option value="">Choose…</option><option>Owned</option><option>Leased</option><option>Mixed</option></select></div>
                                <div class="cv2-field"><label class="cv2-label">Company Owner</label><input type="text" name="company_owner" placeholder="Owner name" maxlength="100"></div>
                                ...
                                <div class="cv2-field"><label class="cv2-label">PAN No</label><input type="text" name="pan_no" maxlength="100" placeholder="ABCDE1234F"></div>
                                <div class="cv2-field"><label class="cv2-label">PAN Status</label><select class="cv2-select" name="pan_status_id" style="width:100%;"><option value="">Choose…</option><option>Verified</option><option>Pending</option></select></div>
                                ...
                                <div class="cv2-field" data-when="gst-registered" style="display:none;"><label class="cv2-label">GST Number <span class="req">*</span></label><input type="text" name="gst_number" placeholder="18AAACB7711P1Z4" maxlength="100"></div>
                                <div class="cv2-field"><label class="cv2-label">TDS Percentage</label><input type="number" name="tds_percentage" id="cv2Tds" placeholder="0" min="0" max="100" step="0.01"></div>
                            </div>
                            <div class="cv2-note is-warn cv2-mt" id="cv2TdsNote" style="display:none;">
                                <i class="bi bi-exclamation-triangle"></i>
                                <div>Because TDS percentage is <b>0 or 1</b>, a <b>TDS Declaration</b> document (type 7) is mandatory. Attach it in the Documents section below before saving.</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cv2-card">
                        ...
                        <div class="cv2-card-b">
                            <div class="cv2-form-grid">
                                ...
                                <div class="cv2-field is-full"><label class="cv2-label">Additional Info</label><textarea name="additional_info" rows="2" placeholder="Landmark, directions, etc." maxlength="10000"></textarea></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="cv2-card-b" id="cv2BankWrap">
                            <div class="cv2-repeat-row cv2-bank-row is-primary">
                                <div class="cv2-form-grid is-3">
                                    <div class="cv2-field"><label class="cv2-label">Bank <span class="req">*</span></label><select class="cv2-select" name="bank_id[]" style="width:100%;"><option value="">Choose bank</option><option>State Bank of India</option><option>HDFC Bank</option><option>ICICI Bank</option><option>Axis Bank</option></select></div>
                        ...
                        <div class="cv2-card-b" id="cv2PersonWrap">
                            <div class="cv2-repeat-row">
                                <div class="cv2-form-grid is-3">
                                    ...
                                    <div class="cv2-field"><label class="cv2-label">Designation <span class="req">*</span></label><input type="text" placeholder="e.g. Fleet Manager"></div>
                                    <div class="cv2-field"><label class="cv2-label">Phone <span class="req">*</span></label><input type="tel" data-intl-phone="1" placeholder="98640 22114"></div>
                                    <div class="cv2-field"><label class="cv2-label">WhatsApp</label><input type="tel" data-intl-phone="1" placeholder="98640 22114"></div>
                ...
                <div>
                    <div class="cv2-card">
                        ...
                        <div class="cv2-card-b" style="display:flex;flex-direction:column;gap:10px;">
                            <div class="cv2-locked"><i class="bi bi-lock"></i><div><b>Vehicle</b><div class="cv2-hint">Fleet this vendor supplies</div></div></div>
                            <div class="cv2-locked"><i class="bi bi-lock"></i><div><b>Route</b><div class="cv2-hint">Routes the vendor covers</div></div></div>
                    ...
                    <div class="cv2-card cv2-mt">
                        <div class="cv2-card-b" style="display:flex;flex-direction:column;gap:10px;">
                            <button type="submit" form="cv2VendorForm" class="cv2-btn cv2-btn-primary cv2-btn-lg" style="justify-content:center;"><i class="bi bi-check2"></i>Save Vendor</button>
