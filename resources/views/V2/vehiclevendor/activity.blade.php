        ...
        <div class="cv2-grid cv2-grid-2-1 cv2-mt">
            ...
            <div class="cv2-card">
                ...
                <div class="cv2-card-b">
                    <form id="cv2ActivityForm" action="{{ route('contact.v2.vehiclevendor.activitynotes.save') }}" method="POST" data-list-url="{{ route('contact.v2.vehiclevendor.activity', $v['id']) }}">
                        @csrf
