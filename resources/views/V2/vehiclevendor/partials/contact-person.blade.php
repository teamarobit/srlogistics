{{-- Vehicle Vendor V2 — Contact-person repeater row (returned by contactPersonWrapper). --}}
<div class="cv2-repeat-row" data-index="{{ $rowindex }}">
    ...
    <div class="cv2-form-grid is-3">
        ...
        <div class="cv2-field">
            ...
            <input type="text" name="contact_person_designation[{{ $rowindex }}]" placeholder="e.g. Fleet Manager">
        </div>
        <div class="cv2-field">
            <label class="cv2-label">Phone <span class="req">*</span></label>
            <input type="tel" name="contact_person_phone[{{ $rowindex }}]" data-intl-phone="1" placeholder="98640 22114">
        </div>
        <div class="cv2-field">
            <label class="cv2-label">Email</label>
            <input type="email" name="contact_person_email[{{ $rowindex }}]" placeholder="person@vendor.in">
        </div>
        <div class="cv2-field">
