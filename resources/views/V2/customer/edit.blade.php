        ...
        <div class="cv2-grid cv2-grid-2-1">
            <div style="display:flex;flex-direction:column;gap:16px;">
                ...
                <div class="cv2-card">
                    ...
                    <div class="cv2-card-b"><div class="cv2-form-grid">
                        <div class="cv2-field"><label class="cv2-label">Phone <span class="req">*</span></label><input type="tel" name="phone" data-intl-phone="1" value="{{ old('phone', $contact->phone) }}"></div>
                        <div class="cv2-field"><label class="cv2-label">WhatsApp</label><input type="tel" name="whatsapp" data-intl-phone="1" value="{{ old('whatsapp', $contact->whatsapp) }}"></div>
                    ...
                    <div class="cv2-card-b" id="cv2PersonWrap">
                        ...
                        <div class="cv2-repeat-row" data-index="{{ $i }}">
                            ...
                            <div class="cv2-form-grid is-3">
                                ...
                                <div class="cv2-field"><label class="cv2-label">Phone <span class="req">*</span></label><input type="tel" name="contact_person_phone[{{ $i }}]" data-intl-phone="1" value="{{ optional($rel)->phone ?? '' }}"></div>
                                <div class="cv2-field"><label class="cv2-label">WhatsApp</label><input type="tel" name="contact_person_whatsapp[{{ $i }}]" data-intl-phone="1" value="{{ optional($rel)->whatsapp ?? '' }}"></div>
