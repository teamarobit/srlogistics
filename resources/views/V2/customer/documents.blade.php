        ...
        <div class="cv2-grid cv2-grid-2-1 cv2-mt">
            ...
            <div class="cv2-card">
                ...
                <div class="cv2-card-b">
                    <form id="cv2DocForm" action="{{ route('contact.v2.customer.attachment.save') }}" method="POST" enctype="multipart/form-data" data-list-url="{{ route('contact.v2.customer.documents', $c['id']) }}">
                        @csrf
