{{-- Customer V2 — Contact-person repeater row (returned by contactPersonWrapper).
     cv2-styled. Field names mirror the V1 customer-contact-person partial. --}}
<div class="cv2-repeat-row" data-index="{{ $rowindex }}">
    ...
    <div class="cv2-form-grid is-3">
        ...
        <div class="cv2-field">
            <label class="cv2-label">Designation</label>
            <input type="text" name="contact_person_designation[{{ $rowindex }}]" placeholder="e.g. Purchase Head">
        </div>
        <div class="cv2-field">
        ...
        <div class="cv2-field">
            ...
            <input type="tel" name="contact_person_whatsapp[{{ $rowindex }}]" data-intl-phone="1" placeholder="98640 11223">
        </div>
        <div class="cv2-field">
