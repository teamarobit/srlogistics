...
{{-- Add Location modal (Charges Paid By: Load Vendor / SRL / Mixed) --}}
          ...
          <div class="cv2-form-grid">
            ...
            <div class="cv2-field"><label class="cv2-label">Charges Paid By</label>
              <div class="cv2-radio-group" id="cv2BroneBy">
                <span class="cv2-radio"><input type="radio" name="brone_by" id="bb_lv" value="loadvendor"><label for="bb_lv">Load Vendor</label></span>
...
@endsection
@section('js')<script src="{{ asset('js/V2/loadvendor.js?v=1.5') }}"></script>@endsection
