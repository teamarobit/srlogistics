{{-- Load Vendor V2 — Contact-person repeater row (returned by contactPersonWrapper).
     Designation REQUIRED for Load Vendor. Field names mirror the V1 partial. --}}
<div class="cv2-repeat-row" data-index="{{ $rowindex }}">
    ...
    <div class="cv2-form-grid is-3">
        ...
        <div class="cv2-field">
            ...
            <input type="text" name="contact_person_designation[{{ $rowindex }}]" placeholder="e.g. Broker / Manager">
        </div>
        <div class="cv2-field">
