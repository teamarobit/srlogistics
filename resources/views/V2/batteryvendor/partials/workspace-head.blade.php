{{-- Battery Vendor V2 workspace header: profile banner + submodule page navigation.
...
@php
    ...
    $nav = [
        ['key'=>'overview','label'=>'Overview','icon'=>'bi-grid','route'=>'contact.v2.batteryvendor.show','count'=>null],
        ['key'=>'documents','label'=>'Documents','icon'=>'bi-paperclip','route'=>'contact.v2.batteryvendor.documents','count'=>$counts['documents']],
        ['key'=>'battery','label'=>'Battery','icon'=>'bi-battery-charging','route'=>'contact.v2.batteryvendor.battery','count'=>$counts['battery']],
        ['key'=>'activity','label'=>'Activity','icon'=>'bi-clock-history','route'=>'contact.v2.batteryvendor.activity','count'=>$counts['activity']],
    ];
@endphp
...
<div class="cv2-profile">
    <div class="cv2-profile-top">
        ...
        <div class="cv2-profile-actions">
            <a href="{{ route('contact.v2.batteryvendor.edit', $v['id']) }}" class="cv2-btn cv2-btn-ghost"><i class="bi bi-pencil"></i>Edit Info</a>
            <a href="{{ route('contact.v2.batteryvendor.index') }}" class="cv2-btn cv2-btn-soft"><i class="bi bi-list-ul"></i>All Battery Vendors</a>
        </div>
    </div>
