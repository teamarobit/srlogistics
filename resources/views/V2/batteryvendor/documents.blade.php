...
<div class="layout-wrapper">
    ...
    <div class="cv2-wrap"><div class="cv2-container">
        <div class="cv2-phead"><div class="cv2-crumb"><a href="{{ route('contact.v2.batteryvendor.index') }}">Battery Vendors</a> · {{ $v['company'] }} · Documents</div></div>
        @include('V2.batteryvendor.partials.workspace-head')

        @if($v['tds'] <= 1)
        <div class="cv2-note is-warn cv2-mt">
            <i class="bi bi-exclamation-triangle"></i>
            <div><b>TDS Declaration mandatory.</b> This vendor's TDS Percentage is {{ $v['tds'] }} (0 or 1), so a TDS Declaration document (type 7) must be on file. Upload it below if missing.</div>
        </div>
        @endif
        ...
        <div class="cv2-grid cv2-grid-2-1 cv2-mt">
                ...
                <div class="cv2-card-b is-flush">
                    <table class="cv2-table">
                        ...
                        <tbody>
                            ...
                            <tr><td><span class="cv2-t-name"><i class="bi bi-file-earmark-text" style="color:var(--cv2-warn);"></i> tds-declaration.pdf</span> <span class="cv2-pill">Type 7</span></td><td>TDS Declaration</td><td>96 KB</td><td>15 Apr 26</td><td class="cv2-actions"><a href="javascript:void(0)" class="cv2-ic-btn"><i class="bi bi-download"></i></a><a href="javascript:void(0)" class="cv2-ic-btn is-danger cv2-del"><i class="bi bi-trash3"></i></a></td></tr>
                            <tr><td><span class="cv2-t-name"><i class="bi bi-file-earmark-pdf" style="color:var(--cv2-bad);"></i> supply-agreement.pdf</span></td><td>Agreement</td><td>1.1 MB</td><td>02 May 26</td><td class="cv2-actions"><a href="javascript:void(0)" class="cv2-ic-btn"><i class="bi bi-download"></i></a><a href="javascript:void(0)" class="cv2-ic-btn is-danger cv2-del"><i class="bi bi-trash3"></i></a></td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
            <div class="cv2-card">
                ...
                <div class="cv2-card-b">
                    ...
                    <span class="cv2-hint" style="display:block;margin-top:8px;">JPG, PNG or PDF · max 2 MB · up to 2 files per type. TDS Declaration is required when TDS % is 0 or 1.</span>
                </div>
            </div>
        </div>
    </div></div>
