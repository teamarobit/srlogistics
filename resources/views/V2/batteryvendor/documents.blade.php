        ...
        <div class="cv2-grid cv2-grid-2-1 cv2-mt">
                            ...
                            @forelse($coattachments as $doc)
                                ...
                                <tr>
                                    ...
                                    <td class="cv2-actions">
                                        ...
                                        <a href="javascript:void(0)" class="cv2-ic-btn is-danger cv2-del-battery-doc" data-id="{{ $doc->id }}" title="Delete"><i class="bi bi-trash3"></i></a>
                                    </td>
                                </tr>
                            @empty
            ...
            <div class="cv2-card">
                ...
                <div class="cv2-card-b">
                    <form id="cv2DocForm" action="{{ route('contact.v2.batteryvendor.attachment.save') }}" method="POST" enctype="multipart/form-data" data-list-url="{{ route('contact.v2.batteryvendor.documents', $v['id']) }}">
                        @csrf
