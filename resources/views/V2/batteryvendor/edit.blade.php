...
<div class="layout-wrapper">
    ...
    <div class="cv2-wrap"><div class="cv2-container">
        ...
        <form id="cv2EditForm" action="{{ route('contact.v2.batteryvendor.update', $v['id']) }}" method="POST" enctype="multipart/form-data" class="cv2-mt" data-show-url="{{ route('contact.v2.batteryvendor.index') }}" data-person-wrapper-url="{{ route('contact.v2.batteryvendor.contactpersonwrapper') }}">
        @csrf
            ...
            <div style="display:flex;flex-direction:column;gap:16px;">
                ...
                <div class="cv2-card">
                    ...
                    <div class="cv2-card-b"><div class="cv2-form-grid">
                        <div class="cv2-field"><label class="cv2-label">GST Number <span class="req">*</span></label><input type="text" name="gst_number" value="{{ old('gst_number', $contact->gst_number) }}" maxlength="100"><span class="cv2-help">Required for battery vendors.</span></div>
                ...
                <div class="cv2-card">
                    ...
                    <div class="cv2-card-b"><div class="cv2-form-grid">
                        ...
                        <div class="cv2-field"><label class="cv2-label">City <span class="req">*</span></label>
                            <select class="cv2-select" id="cv2BatteryCity" name="city_id" data-old="{{ old('city_id', $contact->city_id) }}" style="width:100%;">
