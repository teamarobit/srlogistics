        ...
        <div class="cv2-container">
            ...
            <div class="cv2-phead">
                ...
                <div class="cv2-phead-actions">
                    ...
                    <button type="submit" form="cv2BatteryVendorForm" class="cv2-btn cv2-btn-primary"><i class="bi bi-check2"></i>Save Battery Vendor</button>
                </div>
            </div>

            <form id="cv2BatteryVendorForm" action="javascript:void(0)" data-create="1">
            <div class="cv2-grid cv2-grid-2-1">
                <div style="display:flex;flex-direction:column;gap:16px;">
                        ...
                        <div class="cv2-card-b">
                            <div class="cv2-form-grid">
                                ...
                                <div class="cv2-field">
                                    ...
                                    <input type="text" name="gst_treatment" value="Registered" readonly>
                                ...
                                <div class="cv2-field">
                                    ...
                                    <input type="text" name="contact_code" placeholder="e.g. AMR-01" maxlength="100">
                                </div>
                                <div class="cv2-field">
                                    <label class="cv2-label">No. of Vehicles</label>
                                    <input type="number" name="no_of_vehicles" placeholder="0" min="0">
                                </div>
                    ...
                    <div class="cv2-card">
                        ...
                        <div class="cv2-card-b">
                            <div class="cv2-form-grid">
                                <div class="cv2-field"><label class="cv2-label">Full Company Name</label><input type="text" name="full_company_name" placeholder="Legal name" maxlength="100"></div>
                                ...
                                <div class="cv2-field"><label class="cv2-label">Company Registration No</label><input type="text" name="company_registration_no" placeholder="Registration no" maxlength="100"></div>
                                ...
                                <div class="cv2-field"><label class="cv2-label">PAN No</label><input type="text" name="pan_no" placeholder="ABCDE1234F" maxlength="100"></div>
                                <div class="cv2-field"><label class="cv2-label">PAN Status</label><select class="cv2-select" name="pan_status_id" style="width:100%;"><option value="">Choose…</option><option>Linked</option><option>Not Linked</option><option>Pending</option></select></div>
                                <div class="cv2-field">
                                    <label class="cv2-label">TDS Percentage</label>
                                    <input type="number" name="tds_percentage" id="cv2Tds" step="0.01" min="0" max="100" placeholder="e.g. 5">
                    ...
                    <div class="cv2-card">
                        ...
                        <div class="cv2-card-b">
                            <div class="cv2-form-grid">
                                ...
                                <div class="cv2-field"><label class="cv2-label">City <span class="req">*</span></label><select class="cv2-select" name="city_id" style="width:100%;"><option value="">Choose city…</option><option>Guwahati</option><option>Dibrugarh</option><option>Silchar</option></select></div>
                                ...
                                <div class="cv2-field is-full"><label class="cv2-label">Additional Info</label><textarea name="additional_info" rows="2" placeholder="Notes" maxlength="10000"></textarea></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="cv2-card-b" id="cv2BankWrap">
                            <div class="cv2-repeat-row">
                                <div class="cv2-form-grid is-3">
                                    <div class="cv2-field"><label class="cv2-label">Bank <span class="req">*</span></label><select class="cv2-select" name="bank_id[]" style="width:100%;"><option value="">Choose bank…</option><option>SBI</option><option>HDFC Bank</option><option>ICICI Bank</option><option>Axis Bank</option></select></div>
                                    ...
                                    <div class="cv2-field"><label class="cv2-label">Primary</label>
                                        <div class="cv2-radio-group"><span class="cv2-radio"><input type="radio" name="bank_primary" value="0" checked><label>Primary</label></span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div>
                    ...
                    <div class="cv2-card cv2-mt">
                        <div class="cv2-card-b" style="display:flex;flex-direction:column;gap:10px;">
                            <button type="submit" form="cv2BatteryVendorForm" class="cv2-btn cv2-btn-primary cv2-btn-lg" style="justify-content:center;"><i class="bi bi-check2"></i>Save Battery Vendor</button>
