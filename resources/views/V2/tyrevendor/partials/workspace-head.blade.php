{{-- Tyre Vendor V2 workspace header: profile banner + submodule page navigation.
...
@php
    ...
    $nav = [
        ['key'=>'overview','label'=>'Overview','icon'=>'bi-grid','route'=>'contact.v2.tyrevendor.show','count'=>null],
        ['key'=>'documents','label'=>'Documents','icon'=>'bi-paperclip','route'=>'contact.v2.tyrevendor.documents','count'=>$counts['documents']],
        ['key'=>'tyre','label'=>'Tyre','icon'=>'bi-record-circle','route'=>'contact.v2.tyrevendor.tyre','count'=>$counts['tyres']],
        ['key'=>'activity','label'=>'Activity','icon'=>'bi-clock-history','route'=>'contact.v2.tyrevendor.activity','count'=>$counts['activity']],
    ];
@endphp
    ...
    <div class="cv2-profile-top">
        ...
        <div class="cv2-profile-id">
            ...
            <div class="cv2-profile-meta">
                ...
                <span><i class="bi bi-upc"></i>{{ $v['code'] }}</span>
        ...
        <div class="cv2-profile-actions">
            <a href="{{ route('contact.v2.tyrevendor.edit', $v['id']) }}" class="cv2-btn cv2-btn-ghost"><i class="bi bi-pencil"></i>Edit Info</a>
            <a href="{{ route('contact.v2.tyrevendor.index') }}" class="cv2-btn cv2-btn-soft"><i class="bi bi-list-ul"></i>All Tyre Vendors</a>
        </div>
    </div>
