                  ...
                  <div class="topbar">
                    ...
                    <div class="addroute-bd">
                      <div class="container-fluid">
                        ...
                        <form action="{{route('vehiclestatus.save')}}" method="POST" id="addForm">
                            @csrf

                          <div class="form-group row pb-1">
                            <div class="col-12 col-md-3">
                                <label>Vehicle Status <span class="text-danger">*</span></label>
                            </div>
                            <div class="col-12 col-md-6">
                                <input type="text" name="vehiclestatus_name" value="{{ old('vehiclestatus_name') }}" class="form-control">
                                <small class="error text-danger" id="add_vehiclestatus_name_error"></small>
                            </div>
                          </div>
