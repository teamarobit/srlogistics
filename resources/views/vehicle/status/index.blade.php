                    ...
                    <div class="topbar">
                       <div class="container-fluid page-head">
                          <div class="row align-items-end">
                              <div class="col-12">
                                  <h5 class="d-inline-block mb-0">Vehicle Status</h5>
                                  <a href="{{ route('vehiclestatus.create') }}" class="btn btn-theme mb-0 ms-2"><i class="uil uil-plus me-1"></i>Vehicle Status</a>
                                  
                                  <form action="{{ route('vehiclestatus.index') }}" id="searchform" class="d-inline-block">
                                  ...
                                  <a href="{{ route('vehiclestatus.index') }}" class="btn btn-primary reset-btn"><i class="uil uil-history me-1"></i>Reset</a>
                                            ...
                                            <td class="text-end">
                                                <div class="dropdown dot-dd">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('vehiclestatus.edit', $val->id) }}">
                                                        ...
                                                        {{--<li>
                                                            <a class="dropdown-item text-danger deleteBtn"
                                                               ...
                                                               data-url="{{ route('vehiclestatus.delete', ['id' => $val->id]) }}">
...
<script type="text/javascript" src="{{asset('public/customjs/vehicle/status/index.js')}}"></script>
