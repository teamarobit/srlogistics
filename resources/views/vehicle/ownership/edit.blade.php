                  ...
                  <div class="topbar">
                    ...
                    <div class="addroute-bd">
                      <div class="container-fluid">
                        ...
                        <form action="{{route('vehicleownership.update')}}" method="POST" id="editForm">
                            @csrf
                            ...
                            <div class="form-group row pb-1">
                                ...
                                <div class="col-12 col-md-6">
                                    <input type="text" name="ownership_name" value="{{ old('ownership_name', $editData->name) }}" class="form-control">
                                    <small class="error text-danger" id="edit_ownership_name_error"></small>
                                </div>
                            </div>
...
<script type="text/javascript" src="{{asset('public/customjs/vehicle/ownership/edit.js')}}"></script>
