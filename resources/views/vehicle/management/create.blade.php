                              ...
                              <div class="col-12 col-md-7">
                                ...
                                <form action="{{route('vehiclemanagement.save')}}" method="POST" id="addForm">
                                    ...
                                    <div class="form-group row pb-2">
                                        ...
                                        <div class="col-12 col-md-8">
                                            <div class="input-group">
                                              <input type="text" name="vc_no" id="vc_no" class="form-control" placeholder="e.g. TS09QA1234">
                                    ...
                                    <div class="form-group row pb-1">
                                        ...
                                        <div class="col-12 col-md-8">
                                            <select class="form-select" name="vehicle_size" id="vehicle_size" disabled>
                                                <option value="">Choose</option>
                                            </select>
                                            <small class="text-muted">Select a Vehicle Type above to load sizes.</small>
                                            <small class="error text-danger d-block" id="add_vehicle_size_error"></small>
                                        </div>
                                    </div>
