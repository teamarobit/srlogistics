                       ...
                       <div class="itemcard_body">
                            ...
                            --}}
                               ...
                               <div class="title_top">
                                ...
                                <form method="POST" action="{{ route('login') }}" class="itemform">
                                    @csrf
                                    ...
                                    <div class="forgotpas_sec">
                                        <div class="row item_row">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <a href="{{ route('password.request') }}" class="forgot_pas">Forgot Password?</a>
                                            </div>
                                            
                                            <div class="col-12 col-md-6 ">
                                                <button type="submit" class="login_btn">Log In <i class="uil uil-arrow-right"></i></button>
                                            </div>
                                ...
                                <p class="copyright_sec">&copy; Copyright 2026 <b>SR Logistics</b> - All rights reserved</p>
