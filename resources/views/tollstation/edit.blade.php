                  ...
                  <div class="container-fluid">
                    ...
                    <form action="{{route('tollstation.update')}}" method="POST" id="editForm">
                        ...
                        <div class="form-group row pb-1">
                            ...
                            <div class="col-12 col-md-6">
                                <input type="text" name="station_name" value="{{ old('station_name', $tollstation->station_name) }}" class="form-control">
                                <small class="error text-danger" id="edit_station_name_error"></small>
                            </div>
                        </div>
                        ...
                        <div class="form-group row pb-1">
                            ...
                            <div class="col-12 col-md-6">
                                <input type="text" name="toll_company" value="{{ old('toll_company', $tollstation->toll_company) }}" class="form-control">
                                <small class="error text-danger" id="edit_toll_company_error"></small>
                            </div>
                        </div>
                        ...
                        <!--    </div>-->
                        <!--    <div class="col-12 col-md-6">-->
                        <!--        <input type="text" name="location" value="{{ old('location', $tollstation->location) }}" class="form-control">-->
                        <!--        <small class="error text-danger" id="edit_location_error"></small>-->
                        <!--    </div>-->
                        <!--</div>-->
                                ...
                                <select class="form-select select2 dependent-select" name="state_id" id="gstState" data-target="gstCity">
                                    ...
                                    @foreach ($states as $state)
                                        <option value="{{ $state->id }}" data-url="{{ route('getcities', $state->id) }}"
                                            {{ $state->id == $tollstation->state_id ? 'selected' : '' }}>
                                            {{ $state->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-md-6">
                              <select class="form-select select2" name="city_id" id="gstCity">
                                <option value="">Choose..</option>
                                @php
                                    $cities = optional($tollstation->state)->cities;
                                @endphp
                                
                                @if($cities && $cities->count())
                                    @foreach($cities as $city)
                                        <option value="{{$city->id}}" @selected($city->id === $tollstation->city_id)>{{$city->name}}</option>
                                    @endforeach
                                @endif
                              </select>
                        ...
                        <div class="form-group row pb-1">
                            ...
                            <div class="col-12 col-md-6">
                                <input type="text" name="embed_map_location" value="{{ old('embed_map_location', $tollstation->embed_map_location) }}" class="form-control">
                        ...
                        <div class="form-group row pb-1">
                            ...
                            <div class="col-12 col-md-6">
                                <textarea name="address" class="form-control" rows="3" placeholder="">{{ old('address', $tollstation->address) }}</textarea>
                          ...
                          <div class="col-12 col-md-6">
                              <div class="d-flex flex-wrap">
                                  <div class="form-check d-flex me-2">
                                      <input class="form-check-input" type="radio" name="status" id="exampleRadios1" value="Active" {{ old('status', $tollstation->status) == 'Active' ? 'checked' : '' }} >
                                  ...
                                  <div class="form-check d-flex">
                                      <input class="form-check-input" type="radio" name="status" id="exampleRadios2" value="Inactive" {{ old('status', $tollstation->status) == 'Inactive' ? 'checked' : '' }} >
