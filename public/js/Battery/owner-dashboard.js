/**
 * SR Logistics — Battery Owner Dashboard
 * File: public/js/Battery/owner-dashboard.js
 * Version: 1.0
...
$(document).ready(function () {
    ...
    $('#bod-filter-form').on('submit', function (e) {
        e.preventDefault();
    ...
    /* ── Reset Filters ─────────────────────────────────────────────────── */
    $('#bod-filter-reset').on('click', function () {
...
/**
 * Animate number counters — targets elements with class .bod-count-animate
 * Reads data-target for final value.
 */
function animateCounters() {
    $('.bod-count-animate').each(function () {
        var $el      = $(this);
