...
$(document).ready(function(){
    ...
    $(document).on('click', '.vehiclevendor-status', function () {
    ...
    $(document).on('click', '.add-person', function (e) {
        ...
        var currentIndex = contactperson_rowindex;
    ...
    $('form#editContactForm').on("submit",function(e){
        ...
        if (tdsPercentage === 0) {
            ...
            // Check EXISTING attachments (hidden input from Blade)
            if (!hasTdsDeclaration) {
                ...
                if (existing) {
                    try {
                        ...
                        if (existingArray.includes(8)) {
                            hasTdsDeclaration = true;
                        }
                    } catch (e) {
                        console.log('Invalid JSON in existing_attachtypes');
                    }
                }
            }
        ...
        // Continue with AJAX only if valid
