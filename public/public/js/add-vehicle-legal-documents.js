...
// Checkbox add/remove class
  $('.clickto-adclass02').change(function(){
      if ($(this).is(':checked')) {
          $('.days-beforeexpiry02').addClass('active');
      } else {
          $('.days-beforeexpiry02').removeClass('active');
      }
  });
...
$(document).ready(function() {
      ...
      const vehicleData = {
        "WB01": {
          docNumber: "58L20",
          issuingAuth: "RTO Kolkata",
          issueDate: "2025-02-25",
          expiryDate: "2025-09-12"
        },
        "WB02": {
          docNumber: "88X45",
          issuingAuth: "RTO Howrah",
          issueDate: "2025-01-10",
          expiryDate: "2026-01-10"
        },
        "WB04": {
          docNumber: "74B32",
          issuingAuth: "RTO Durgapur",
      ...
      $("#vehicle").on("change", function() {
        ...
        if (vehicle && vehicleData[vehicle]) {
          ...
          $("#issuingAuth").val(data.issuingAuth);
          $("#issueDate").val(data.issueDate);
          $("#expiryDate").val(data.expiryDate);
        } else {
          $("#docNumber, #issuingAuth, #issueDate, #expiryDate").val("");
        }
      });
    });
